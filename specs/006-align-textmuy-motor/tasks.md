...
- [X] T028 [P] Puertas Node del módulo desde `modules/textmuy/` (`node --check` de todos los JS + las 14 suites `node tests/*.test.js` en verde, incluyendo `galeria-items`, `invalidacion`, `sprite-canonico` y `rc-bump`; RC36)
